...
function quickKeywordParse(message) {
  ...
  if (
    ...
    return {
      ...
      message:
        "🌟 مرحباً بك في منصة مراسيل! أنا مساعدك الذكي المتخصص في شحنات السعودية 🇸🇦\n\n✨ يمكنني مساعدتك في:\n• 📦 تتبع وإنشاء الشحنات\n• 💰 إدارة رصيد محفظتك\n• 📋 عرض تاريخ شحناتك\n• 🏢 معلومات عن شركات الشحن المتاحة\n• ❓ إجابة أسئلتك عن خدماتنا\n\nكيف يمكنني مساعدتك اليوم؟ 😊",
    };
  }

  // أسئلة عن الشركة والخدمات
  if (
    (lowerMessage.includes("من") && lowerMessage.includes("مراسيل")) ||
    (lowerMessage.includes("ما هي") && lowerMessage.includes("مراسيل")) ||
    lowerMessage.includes("عن الشركة") ||
    lowerMessage.includes("about")
  ) {
    return {
      action: "CHAT_RESPONSE",
      message:
        "🏢 **مراسيل** هي منصة الشحن الذكية الرائدة في السعودية!\n\n⭐ **رؤيتنا**: تسهيل تجارة التجزئة عبر الإنترنت من خلال حلول شحن متكاملة\n\n🚀 **خدماتنا**:\n• شحن سريع وآمن لجميع أنحاء السعودية\n• تتبع فوري للشحنات\n• نظام محافظ إلكترونية آمن\n• دعم فني على مدار 24 ساعة\n• شراكات مع أفضل شركات الشحن المحلية\n\n📞 للتواصل: support@marasil.com",
    };
  }

  // أسئلة عن شركات الشحن
  if (
    lowerMessage.includes("شركات الشحن") ||
    lowerMessage.includes("shipping companies") ||
    lowerMessage.includes("ما الشركات") ||
    lowerMessage.includes("شركات متوفرة")
  ) {
    return {
      action: "CHAT_RESPONSE",
      message:
        "🚛 **شركاء الشحن في منصة مراسيل**:\n\n🏆 **ARAMEX**\n• أسرع خدمة شحن في السعودية\n• تغطية شاملة لجميع المدن\n• تتبع متقدم عبر الإنترنت\n\n🚚 **SMSA**\n• خدمة موثوقة وآمنة\n• مناسبة للشحنات الكبيرة\n• شبكة توزيع واسعة\n\n✈️ **DHL**\n• شحن دولي ومحلي\n• ضمان عالي للسلامة\n• تتبع عالمي\n\n💡 **نصيحة**: اختر الشركة المناسبة حسب حجم وسرعة الشحنة المطلوبة!",
    };
  }
  ...
  if (
    ...
    lowerMessage.includes("كم التكلفة") ||
    ...
    return {
      action: "CHAT_RESPONSE",
      message:
        "💰 **أسعار شحن مراسيل**:\n\n📏 **حساب التكلفة التلقائي**:\n• يعتمد على الوزن والمسافة\n• يختلف حسب شركة الشحن\n• يشمل جميع الرسوم\n\n💡 **عوامل التأثير على السعر**:\n• وزن الشحنة (كيلو)\n• المسافة بين المدن\n• حجم الطرد\n• شركة الشحن المختارة\n\n🎁 **عروض خاصة**:\n• خصومات للشحنات الكبيرة\n• عروض شهرية للعملاء الدائمين\n• شحن مجاني للطلبات الكبيرة\n\n💬 اسألني عن شحنة محددة لحساب التكلفة الدقيقة!",
    };
  }
